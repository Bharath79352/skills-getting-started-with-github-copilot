        ...
        const participantsList = details.participants
          .map(
            ...
            <li>
              ...
              <button class="delete-participant" data-activity="${name}" data-participant="${participant}">Delete</button>
            </li>
          `
          )
          .join("");
        ...
        activityCard.querySelectorAll(".delete-participant").forEach((button) => {
          button.addEventListener("click", async (event) => {
            ...
            try {
              ...
              if (response.ok) {
                messageDiv.textContent = `${participant} unregistered from ${activity}`;
